...
import FertigramRadarChart from "@/components/Fertigram/FertigramRadarChart";
      ...
      {hasNoNutrients ? (
        ...
        <VStack align="stretch" gap={4}>
          ...
          <FertigramRadarChart
            ...
            nutrients={safeMacronutrients.map((item) => ({
              name: item.nutrient,
              measuredValue: item.measuredValue,
              recommendedMin: item.recommendedMinimum,
              recommendedMax: item.recommendedMaximum,
              unit: item.unit,
          ...
          <FertigramRadarChart
            ...
            nutrients={safeMicronutrients.map((item) => ({
              name: item.nutrient,
              measuredValue: item.measuredValue,
              recommendedMin: item.recommendedMinimum,
              recommendedMax: item.recommendedMaximum,
