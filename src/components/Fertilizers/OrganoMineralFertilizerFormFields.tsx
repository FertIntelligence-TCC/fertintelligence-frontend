...
export default function OrganoMineralFertilizerFormFields({ form, onChange, readOnly }: Props) {
    return (
        <VStack gap={5} align="stretch" py={2}>
            ...
            <Box>
                <Text fontWeight="bold" mb={2} color="green.600" _dark={{ color: "green.300" }} borderBottomWidth="1px" pb={1}>Identificação</Text>
            ...
            {/* Macronutrientes */}
            <Box>
                <Text fontWeight="bold" mb={2} color="green.600" _dark={{ color: "green.300" }} borderBottomWidth="1px" pb={1}>Macronutrientes (%)</Text>
