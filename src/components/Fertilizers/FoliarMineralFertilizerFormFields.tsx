...
export default function FoliarMineralFertilizerFormFields({ form, onChange, readOnly }: Props) {
    return (
        <VStack gap={5} align="stretch" py={2}>
            ...
            {/* Identificação */}
            <Box>
                <Text fontWeight="bold" mb={2} color="blue.600" _dark={{ color: "blue.300" }} borderBottomWidth="1px" pb={1}>Identificação</Text>
                <InputField 
                    label="Nome do Adubo *" 
                    type="text" 
                    value={form.nome} 
            ...
            <Box>
                <Text fontWeight="bold" mb={2} color="blue.600" _dark={{ color: "blue.300" }} borderBottomWidth="1px" pb={1}>Macronutrientes Primários (%)</Text>
            ...
            <Box>
                <Text fontWeight="bold" mb={2} color="blue.600" _dark={{ color: "blue.300" }} borderBottomWidth="1px" pb={1}>Macronutrientes Secundários (%)</Text>
                <Grid templateColumns="repeat(3, 1fr)" gap={3}>
            ...
            {/* Micronutrientes */}
            <Box>
                <Text fontWeight="bold" mb={2} color="blue.600" _dark={{ color: "blue.300" }} borderBottomWidth="1px" pb={1}>Micronutrientes (%)</Text>
                <Grid templateColumns="repeat(3, 1fr)" gap={3}>
            ...
            {/* Índices */}
            <Box>
                <Text fontWeight="bold" mb={2} color="blue.600" _dark={{ color: "blue.300" }} borderBottomWidth="1px" pb={1}>Índices Físico-Químicos</Text>
