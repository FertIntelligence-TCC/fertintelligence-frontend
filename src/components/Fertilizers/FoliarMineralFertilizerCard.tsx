...
export default function FoliarMineralFertilizerCard({ item, isSelected, onSelect, onView, onEdit, onDelete }: Props) {
    return (
        <Box
            borderWidth="1px"
            borderRadius="md"
        ...
        >
            <Flex justify="space-between" align="start">
                <Text fontWeight="bold" fontSize="lg" color="blue.700" _dark={{ color: "blue.300" }} mb={1}>
                    {item.nome_adubo}
                </Text>
                <Badge colorPalette="blue" variant="surface">Foliar Mineral</Badge>
            </Flex>
