...
const mapFertilityToFormData = (
    ...
    saturacaoMagnesioCtc: data.saturacao_magnesio_ctc,
    saturacaoHidrogenioCtc: data.saturacao_hidrogenio_ctc,
    saturacaoAluminioCtc: data.saturacao_aluminio_ctc,
    relacaoCalcioMagnesio: data.relacao_calcio_magnesio,
    relacaoCalcioPotassio: data.relacao_calcio_potassio,
    relacaoMagnesioPotassio: data.relacao_magnesio_potassio,
    relacaoCalcioMagnesioPotassio: data.relacao_calcio_magnesio_potassio,
