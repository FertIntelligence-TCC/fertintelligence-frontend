...
import { 
    ...
    fetchPublicChelatedFertilizers 
...
export default function ChelatedFertilizer() {
  ...
  const handleOpenPublicFertilizers = async () => {
    await queryClient.prefetchQuery({
      ...
      queryFn: fetchPublicChelatedFertilizers,
    });
    navigate("/fertintelligence/fertilizer-management/chelated-fertilizer/publicos");
  };
