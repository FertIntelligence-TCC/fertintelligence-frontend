                                        ...
                                        {group.extracts.map((ext, idx) => (
                                            <Box key={idx} fontSize="sm">
                                                ...
                                                <HStack color="gray.500" _dark={{ color: "gray.400" }} fontSize="xs" gap={3}>
                                                    <Text>Areia: <b>{ext.teorAreia}</b> g/kg</Text>
                                                    <Text>Silte: <b>{ext.teorSilte}</b> g/kg</Text>
                                                    <Text>Argila: <b>{ext.teorArgila}</b> g/kg</Text>
                                                </HStack>
                                            </Box>
                                        ))}
