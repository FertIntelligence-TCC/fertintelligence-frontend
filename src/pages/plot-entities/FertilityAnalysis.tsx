...
export const FertilityAnalysis = () => {
    ...
    const mapBackendToFormData = useCallback((
        ...
        return {
            ...
            saturacaoMagnesioCtc: c.saturacao_magnesio_ctc,
            saturacaoHidrogenioCtc: c.saturacao_hidrogenio_ctc,
            saturacaoAluminioCtc: c.saturacao_aluminio_ctc,
            relacaoCalcioMagnesio: c.relacao_calcio_magnesio,
            relacaoCalcioPotassio: c.relacao_calcio_potassio,
            relacaoMagnesioPotassio: c.relacao_magnesio_potassio,
            relacaoCalcioMagnesioPotassio: c.relacao_calcio_magnesio_potassio,
