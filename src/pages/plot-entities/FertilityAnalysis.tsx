...
// Componentes
import { FertilityAnalysisFormDialog } from "@/components/FertilityAnalysis/FertilityAnalysisFormDialog";
        ...
        <UserLayout>
            ...
            <Box mt={{ base: 24, md: 32 }} p={6} maxWidth="1400px" marginX="auto">
                ...
                <Flex justify="space-between" align="center" mb={8} wrap="wrap" gap={4}>
                    <Heading size="lg" color="teal.700">Análises de Fertilidade (Química)</Heading>
                    <Button colorPalette="teal" onClick={handleAddNew}>
