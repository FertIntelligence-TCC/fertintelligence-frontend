...
import {
  ...
  getFertilizerPhotoIds, fertilizerCommercialPriceResponseToForm,
...
const toOrganoMineralForm = (item: OrganoMineralFertilizerResponseDto): OrganoMineralFertilizerFormState => ({
  ...
  indiceSalino: String(item.indice_salino ?? 0),
  indiceAcidez: String(item.indice_acidez ?? 0),
  taxaMineralizacaoAno1: item.taxa_mineralizacao_primeiro_ano_percentual == null ? "" : String(item.taxa_mineralizacao_primeiro_ano_percentual),
  taxaMineralizacaoAno2: item.taxa_mineralizacao_segundo_ano_percentual == null ? "" : String(item.taxa_mineralizacao_segundo_ano_percentual),
  taxaMineralizacaoAno3: item.taxa_mineralizacao_terceiro_ano_percentual == null ? "" : String(item.taxa_mineralizacao_terceiro_ano_percentual),
  taxaMineralizacaoAno4: item.taxa_mineralizacao_quarto_ano_percentual == null ? "" : String(item.taxa_mineralizacao_quarto_ano_percentual),
  publico: publicValue(item.publico),
});
...
const toGreenForm = (item: GreenFertilizerResponseDto): GreenFertilizerFormState => ({
  ...DEFAULT_GREEN_FERTILIZER_FORM_STATE,
  nome: item.nome_adubo,
  umidadeIncorporacao: item.umidade_incorporacao_percentual == null ? "" : String(item.umidade_incorporacao_percentual),
  fotoIds: getFertilizerPhotoIds(item), ...fertilizerCommercialPriceResponseToForm(item),
  observacao: item.observacao ?? "",
  fonte: item.fonte ?? "",
  c: String(item.c ?? 0),
  ...
  taxaMineralizacaoAno1: String(item.taxa_mineralizacao_primeiro_ano_percentual ?? item.taxa_mineralizacao_ano_1 ?? 0),
  taxaMineralizacaoAno2: String(item.taxa_mineralizacao_segundo_ano_percentual ?? item.taxa_mineralizacao_ano_2 ?? 0),
  taxaMineralizacaoAno3: String(item.taxa_mineralizacao_terceiro_ano_percentual ?? item.taxa_mineralizacao_ano_3 ?? 0),
  taxaMineralizacaoAno4: item.taxa_mineralizacao_quarto_ano_percentual == null ? "" : String(item.taxa_mineralizacao_quarto_ano_percentual),
  publico: publicValue(item.publico),
});
...
const toOrganicForm = (item: OrganicFertilizerResponseDto): OrganicFertilizerFormState => ({
  ...
  taxaMineralizacaoAno3: String(item.taxa_mineralizacao_terceiro_ano_percentual ?? item.taxa_mineralizacao_ano_3 ?? 0),
  taxaMineralizacaoAno4: item.taxa_mineralizacao_quarto_ano_percentual == null ? "" : String(item.taxa_mineralizacao_quarto_ano_percentual),
  arsenio: item.arsenio_mg_kg == null ? "" : String(item.arsenio_mg_kg),
  cadmio: item.cadmio_mg_kg == null ? "" : String(item.cadmio_mg_kg),
  cromio: item.cromio_mg_kg == null ? "" : String(item.cromio_mg_kg),
  chumbo: item.chumbo_mg_kg == null ? "" : String(item.chumbo_mg_kg),
  mercurio: item.mercurio_mg_kg == null ? "" : String(item.mercurio_mg_kg),
  niquel: item.niquel_mg_kg == null ? "" : String(item.niquel_mg_kg),
  selenio: item.selenio_mg_kg == null ? "" : String(item.selenio_mg_kg),
  n: String(item.n ?? 0),
  p2o5: String(item.p2o5 ?? 0),
  k2o: String(item.k2o ?? 0),
  ca: String(item.ca ?? 0),
